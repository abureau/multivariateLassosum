...
#ifndef RCPP_Lassosum_extension_RCPPEXPORTS_H_GEN_
#define RCPP_Lassosum_extension_RCPPEXPORTS_H_GEN_

#include <RcppArmadillo.h>
#include <Rcpp.h>

namespace Lassosum_extension {
    ...
    namespace {
        void validateSignature(const char* sig) {
            ...
            require("Lassosum.extension", Rcpp::Named("quietly") = true);
            typedef int(*Ptr_validate)(const char*);
            static Ptr_validate p_validate = (Ptr_validate)
                R_GetCCallable("Lassosum.extension", "_Lassosum_extension_RcppExport_validate");
            if (!p_validate(sig)) {
                throw Rcpp::function_not_exported(
                    "C++ function with signature '" + std::string(sig) + "' not found in Lassosum.extension");
            }
        }
    }
    ...
    inline int countlines(const char* fileName) {
        ...
        if (p_countlines == NULL) {
            ...
            p_countlines = (Ptr_countlines)R_GetCCallable("Lassosum.extension", "_Lassosum_extension_countlines");
        }
    ...
    inline arma::mat multiBed3(const std::string fileName, int N, int P, const arma::mat input, arma::Col<int> col_skip_pos, arma::Col<int> col_skip, arma::Col<int> keepbytes, arma::Col<int> keepoffset, const int trace) {
        ...
        if (p_multiBed3 == NULL) {
            ...
            p_multiBed3 = (Ptr_multiBed3)R_GetCCallable("Lassosum.extension", "_Lassosum_extension_multiBed3");
        }
        RObject rcpp_result_gen;
        {
            RNGScope RCPP_rngScope_gen;
    ...
    inline arma::mat multiBed3sp(const std::string fileName, int N, int P, const arma::vec beta, const arma::Col<int> nonzeros, const arma::Col<int> colpos, const int ncol, arma::Col<int> col_skip_pos, arma::Col<int> col_skip, arma::Col<int> keepbytes, arma::Col<int> keepoffset, const int trace) {
        ...
        if (p_multiBed3sp == NULL) {
            ...
            p_multiBed3sp = (Ptr_multiBed3sp)R_GetCCallable("Lassosum.extension", "_Lassosum_extension_multiBed3sp");
        }
        RObject rcpp_result_gen;
        {
            RNGScope RCPP_rngScope_gen;
    ...
    inline int elnet(double lambda1, double lambda2, const arma::vec& diag, const arma::mat& X, const arma::vec& r, const arma ::mat& inv_Sb, const arma ::mat& inv_Ss, double thr, arma::vec& x, arma::vec& yhat, int trace, int maxiter) {
        typedef SEXP(*Ptr_elnet)(SEXP,SEXP,SEXP,SEXP,SEXP,SEXP,SEXP,SEXP,SEXP,SEXP,SEXP,SEXP);
        static Ptr_elnet p_elnet = NULL;
        if (p_elnet == NULL) {
            validateSignature("int(*elnet)(double,double,const arma::vec&,const arma::mat&,const arma::vec&,const arma ::mat&,const arma ::mat&,double,arma::vec&,arma::vec&,int,int)");
            p_elnet = (Ptr_elnet)R_GetCCallable("Lassosum.extension", "_Lassosum_extension_elnet");
        }
        RObject rcpp_result_gen;
        {
            RNGScope RCPP_rngScope_gen;
            rcpp_result_gen = p_elnet(Shield<SEXP>(Rcpp::wrap(lambda1)), Shield<SEXP>(Rcpp::wrap(lambda2)), Shield<SEXP>(Rcpp::wrap(diag)), Shield<SEXP>(Rcpp::wrap(X)), Shield<SEXP>(Rcpp::wrap(r)), Shield<SEXP>(Rcpp::wrap(inv_Sb)), Shield<SEXP>(Rcpp::wrap(inv_Ss)), Shield<SEXP>(Rcpp::wrap(thr)), Shield<SEXP>(Rcpp::wrap(x)), Shield<SEXP>(Rcpp::wrap(yhat)), Shield<SEXP>(Rcpp::wrap(trace)), Shield<SEXP>(Rcpp::wrap(maxiter)));
        }
        if (rcpp_result_gen.inherits("interrupted-error"))
            throw Rcpp::internal::InterruptedException();
        if (Rcpp::internal::isLongjumpSentinel(rcpp_result_gen))
    ...
    inline int repelnet(double lambda1, double lambda2, arma::vec& diag, arma::mat& X, arma::vec& r, arma ::mat& inv_Sb, arma ::mat& inv_Ss, double thr, arma::vec& x, arma::vec& yhat, int trace, int maxiter, arma::Col<int>& startvec, arma::Col<int>& endvec) {
        ...
        if (p_repelnet == NULL) {
            validateSignature("int(*repelnet)(double,double,arma::vec&,arma::mat&,arma::vec&,arma ::mat&,arma ::mat&,double,arma::vec&,arma::vec&,int,int,arma::Col<int>&,arma::Col<int>&)");
            p_repelnet = (Ptr_repelnet)R_GetCCallable("Lassosum.extension", "_Lassosum_extension_repelnet");
        }
        RObject rcpp_result_gen;
        {
            RNGScope RCPP_rngScope_gen;
            rcpp_result_gen = p_repelnet(Shield<SEXP>(Rcpp::wrap(lambda1)), Shield<SEXP>(Rcpp::wrap(lambda2)), Shield<SEXP>(Rcpp::wrap(diag)), Shield<SEXP>(Rcpp::wrap(X)), Shield<SEXP>(Rcpp::wrap(r)), Shield<SEXP>(Rcpp::wrap(inv_Sb)), Shield<SEXP>(Rcpp::wrap(inv_Ss)), Shield<SEXP>(Rcpp::wrap(thr)), Shield<SEXP>(Rcpp::wrap(x)), Shield<SEXP>(Rcpp::wrap(yhat)), Shield<SEXP>(Rcpp::wrap(trace)), Shield<SEXP>(Rcpp::wrap(maxiter)), Shield<SEXP>(Rcpp::wrap(startvec)), Shield<SEXP>(Rcpp::wrap(endvec)));
        }
        if (rcpp_result_gen.inherits("interrupted-error"))
            throw Rcpp::internal::InterruptedException();
        if (Rcpp::internal::isLongjumpSentinel(rcpp_result_gen))
    ...
    inline arma::mat genotypeMatrix(const std::string fileName, int N, int P, arma::Col<int> col_skip_pos, arma::Col<int> col_skip, arma::Col<int> keepbytes, arma::Col<int> keepoffset, const int fillmissing) {
        ...
        if (p_genotypeMatrix == NULL) {
            ...
            p_genotypeMatrix = (Ptr_genotypeMatrix)R_GetCCallable("Lassosum.extension", "_Lassosum_extension_genotypeMatrix");
        }
        RObject rcpp_result_gen;
        {
            RNGScope RCPP_rngScope_gen;
    ...
    inline arma::vec normalize(arma::mat& genotypes) {
        ...
        if (p_normalize == NULL) {
            ...
            p_normalize = (Ptr_normalize)R_GetCCallable("Lassosum.extension", "_Lassosum_extension_normalize");
        }
        RObject rcpp_result_gen;
        {
            RNGScope RCPP_rngScope_gen;
    ...
    inline arma::mat GenotypeMatrixMultiplePhenotypes(const arma::mat& GenotypeMatrix, int q) {
        ...
        if (p_GenotypeMatrixMultiplePhenotypes == NULL) {
            ...
            p_GenotypeMatrixMultiplePhenotypes = (Ptr_GenotypeMatrixMultiplePhenotypes)R_GetCCallable("Lassosum.extension", "_Lassosum_extension_GenotypeMatrixMultiplePhenotypes");
        }
        RObject rcpp_result_gen;
        {
            RNGScope RCPP_rngScope_gen;
    ...
    inline arma::vec sd_MultiplePhenotypes(const arma::vec& sd, int q) {
        ...
        if (p_sd_MultiplePhenotypes == NULL) {
            ...
            p_sd_MultiplePhenotypes = (Ptr_sd_MultiplePhenotypes)R_GetCCallable("Lassosum.extension", "_Lassosum_extension_sd_MultiplePhenotypes");
        }
        RObject rcpp_result_gen;
        {
            RNGScope RCPP_rngScope_gen;
    ...
    inline List runElnet(arma::vec& lambda, double shrink, const std::string fileName, arma::mat& cor, arma ::mat& inv_Sb, arma ::mat& inv_Ss, int N, int P, arma::Col<int>& col_skip_pos, arma::Col<int>& col_skip, arma::Col<int>& keepbytes, arma::Col<int>& keepoffset, double thr, arma::mat& init, int trace, int maxiter, arma::Col<int>& startvec, arma::Col<int>& endvec) {
        ...
        if (p_runElnet == NULL) {
            validateSignature("List(*runElnet)(arma::vec&,double,const std::string,arma::mat&,arma ::mat&,arma ::mat&,int,int,arma::Col<int>&,arma::Col<int>&,arma::Col<int>&,arma::Col<int>&,double,arma::mat&,int,int,arma::Col<int>&,arma::Col<int>&)");
            p_runElnet = (Ptr_runElnet)R_GetCCallable("Lassosum.extension", "_Lassosum_extension_runElnet");
        }
        RObject rcpp_result_gen;
        {
            RNGScope RCPP_rngScope_gen;
...
#endif // RCPP_Lassosum_extension_RCPPEXPORTS_H_GEN_
