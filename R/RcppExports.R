...
countlines <- function(fileName) {
    .Call(`_Lassosum_ext_countlines`, fileName)
}
...
multiBed3 <- function(fileName, N, P, input, col_skip_pos, col_skip, keepbytes, keepoffset, trace) {
    .Call(`_Lassosum_ext_multiBed3`, fileName, N, P, input, col_skip_pos, col_skip, keepbytes, keepoffset, trace)
}
...
multiBed3sp <- function(fileName, N, P, beta, nonzeros, colpos, ncol, col_skip_pos, col_skip, keepbytes, keepoffset, trace) {
    .Call(`_Lassosum_ext_multiBed3sp`, fileName, N, P, beta, nonzeros, colpos, ncol, col_skip_pos, col_skip, keepbytes, keepoffset, trace)
}
...
elnet <- function(lambda1, lambda2, diag, X, r, inv_Sb, inv_Ss, thr, x, yhat, trace, maxiter, sample_size) {
    .Call(`_Lassosum_ext_elnet`, lambda1, lambda2, diag, X, r, inv_Sb, inv_Ss, thr, x, yhat, trace, maxiter, sample_size)
}

repelnet <- function(lambda1, lambda2, diag, X, r, inv_Sb, inv_Ss, thr, x, yhat, trace, maxiter, sample_size, startvec, endvec) {
    .Call(`_Lassosum_ext_repelnet`, lambda1, lambda2, diag, X, r, inv_Sb, inv_Ss, thr, x, yhat, trace, maxiter, sample_size, startvec, endvec)
}
...
genotypeMatrix <- function(fileName, N, P, col_skip_pos, col_skip, keepbytes, keepoffset, fillmissing) {
    .Call(`_Lassosum_ext_genotypeMatrix`, fileName, N, P, col_skip_pos, col_skip, keepbytes, keepoffset, fillmissing)
}
...
normalize <- function(genotypes) {
    .Call(`_Lassosum_ext_normalize`, genotypes)
}
...
Correlation <- function(genotypes) {
    .Call(`_Lassosum_ext_Correlation`, genotypes)
}

GenotypeMatrixMultiplePhenotypes <- function(GenotypeMatrix, q) {
    .Call(`_Lassosum_ext_GenotypeMatrixMultiplePhenotypes`, GenotypeMatrix, q)
}

sd_MultiplePhenotypes <- function(sd, q) {
    .Call(`_Lassosum_ext_sd_MultiplePhenotypes`, sd, q)
}
...
runElnet <- function(lambda, shrink, fileName, cor, inv_Sb, inv_Ss, N, P, col_skip_pos, col_skip, keepbytes, keepoffset, thr, init, trace, maxiter, sample_size, startvec, endvec) {
    .Call(`_Lassosum_ext_runElnet`, lambda, shrink, fileName, cor, inv_Sb, inv_Ss, N, P, col_skip_pos, col_skip, keepbytes, keepoffset, thr, init, trace, maxiter, sample_size, startvec, endvec)
}

# Register entry points for exported C++ functions
methods::setLoadAction(function(ns) {
    .Call('_Lassosum_ext_RcppExport_registerCCallable', PACKAGE = 'Lassosum.ext')
})
